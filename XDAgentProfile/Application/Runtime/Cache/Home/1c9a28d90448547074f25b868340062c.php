...
<html lang="en"><head>
  ...
  <body>
        ...
        <div class="col-sm-offset-1 col-xs-12 col-sm-10">
          <div class="row login-container">
            ...
            <div class="col-sm-7 col-xs-12">
              <form class="form-signin" action="" method="post">
                ...
                <div class="verifybox">
                  ...
                  <img src="/Agent/verify" width="150px;" id="verifyimg" onclick="getverify();">
                  <input name="verify" width="40%" placeholder="验证码" type="text" id="verify"> 
            ...
            <div class="col-sm-5 col-xs-12 signupway-box">
              ...
              <div class="rlink">
                <a href="signup"><h4><span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span><u>点击这里 快速注册 </u></h4></a>
              </div>
              <!--
              <h4>或使用以下帐号直接登录:</h4>
    ...
    $('#signinbtn').click(function(e){
      ...
      if (verifycode == "") {
        alert("验证码不能为空!");
      }else if(passwd == "" || (emaillogin =="" && contractlogin=="")){
        alert("账户密码不能为空!");
      }else{
        $.post("/Agent/signin",
          {
    ...
    function getverify(){
      $("#verifyimg").attr("src","/Agent/verify/");
    }
    </script>
